    ...
    <div class="col-md-5">
        <div class="card shadow-sm">
            <div class="card-body p-4">
                <h4 class="card-title text-center mb-1">Commerce Admin</h4>
                <p class="text-center text-muted small mb-4">관리자 전용 로그인</p>
                <form id="adminLoginForm" onsubmit="return false;">
                    <div class="form-group">
                        <label for="loginId">아이디</label>
                        <input type="text" class="form-control" id="loginId" name="loginId"
                               placeholder="관리자 아이디" maxlength="50" autofocus>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="button" class="btn btn-dark btn-block" onclick="doAdminLogin()">로그인</button>
                </form>
            </div>
        </div>
    </div>
...
function doAdminLogin() {
    ...
    $.ajax({
        url: "<c:url value='/admin/selectLoginProc.do'/>",
        type: "POST",
